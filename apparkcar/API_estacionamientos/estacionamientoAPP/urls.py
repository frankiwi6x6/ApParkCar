...
urlpatterns = [
    ...
    path('dist/<str:latitud_usuario>/<str:longitud_usuario>', views.get_estacionamientos_ordenados_por_distancia, name='estacionamientos_ordenados'),
    path('duenno/<int:id>/', views.lista_estacionamientos_duenno, name='lista_estacionamientos_duenno'),
]